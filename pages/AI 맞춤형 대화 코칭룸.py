...
with tab2:
    ...
    with col1:
        ...
        st.markdown("- **단답형 질문 피하기**: '오늘 뭐 했어요?' 보다는 '오늘 날씨 되게 좋았는데 맛있는 거 드셨어요?' 처럼 답변의 폭을 넓혀주세요.")
        st.markdown("- **'나도' 법칙 활용**: 상대방이 취미를 말했을 때, 격하게 공감하며 나의 관련 경험을 살짝 얹으면 대화가 끊이지 않습니다.")
        st.markdown("- **마무리는 열린 질문으로**: 대화 문장 끝에 가볍게 질문을 던져 상대방이 답장할 명분을 만들어주세요.")
        
    with col2:
        st.subheader("📈 대화를 좋은 쪽으로 리드하는 법")
        st.markdown("- **감정 리액션 먼저**: '나 오늘 지각했어' 라는 말에 '왜 지각함?' 대신 '헐 고생했겠네, 아침부터 가슴 철렁했겠다'가 먼저입니다.")
        st.markdown("- **상대방의 키워드 포착**: 상대가 흘리듯 말한 관심사(영화, 반려견, 맛집)를 기억해 두었다가 다음 대화의 주제로 삼으세요.")
        st.markdown("- **긍정적 에너지 전달**: 불평불만보다는 소소하더라도 기분 좋은 일상 공유가 대화방의 온도를 높입니다.")
